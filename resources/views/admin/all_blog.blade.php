                                                            ...
                                                            <div class="preview-item-content d-flex flex-grow">
                                                                <div class="flex-grow">
                                                                    <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                                                        <h6 class="preview-subject">{{$data->title}}</h6>
            
                                                                    </div>
                                                                    <p class="text-muted">{{Str::limit($data->content, 100)}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="preview-list">
                                                        <div class="preview-item">
                                                            <div class="preview-thumbnail">
                                                                ...
                                                                <img src="{{asset('admin\assets\images\faces-clipart\pic-1.png')}}" alt="image" />
                                                                @else
                                                                <img src="{{asset('admin/assets/user_img/')}}/{{$data->user->profile_img}}" alt="image" />
                                                                @endif
                                                            </div>
                                                            <div class="preview-item-content d-flex flex-grow">
                                                                <div class="flex-grow">
                                                                    <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                                                        <h6 class="preview-subject">{{$data->user->name}}</h6>
            
                                                                    </div>
                                                                    <p class="text-muted">{{$data->user->role->name}}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
